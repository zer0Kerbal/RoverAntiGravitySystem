...
# Version 1.4.0.0-release - `<Dressed for Flight>` edition

* 16 Dec 2022
* Release for Kerbal Space Program 1.6.1
* by zer0Kerbal
...
<div style="border:0.5px solid #BADASS; background-color: lightgrey; color: #FF0000; text-align:center">compiled with: KSP 1.6.1 — Unity 2019.2.2f1 — .net 3.5 — C# 3.0</div>
