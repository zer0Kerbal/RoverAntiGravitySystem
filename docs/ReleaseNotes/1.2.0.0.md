...
# Version 1.2.0.0-release - `<Remaking History>` edition

* 15 Dec 2022
* Release for Kerbal Space Program 1.4.5
* by zer0Kerbal
...
<div style="border:0.5px solid #BADASS; background-color: lightgrey; color: #FF0000; text-align:center">compiled with: KSP 1.4.5 — Unity 2019.2.2f1 — .net 3.5 — C# 3.0</div>
...
<!-- mod -->
[MOD:shd:stat]: https://img.shields.io/badge/Rover%20Anti%20Gravity%20System%20(RAGS)%20-v1.2.0.0--release-BADA55.svg?style=plastic&labelColor=darkgreen/ "1.2.0.0-release"
