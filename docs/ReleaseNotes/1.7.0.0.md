...
[![Rover Anti Gravity System (RAGS))][SHD:mod]][GITHUB:url]  
[![KSP version][SHD:ksp]][KSP:url] [![License][LIC:shd]][LIC:url] [![Pages][SHD:pgs]][pages]
![Code][SHD:code]

## Version 1.7.0.0-release - `<There's No Place Like Kerbin>` edition

* 19 Mar 2023
* Release for Kerbal Space Program 1.9.1
* by [zer0Kerbal](https://github.com/zer0Kerbal)

<div style="border:0.5px solid Tomato; background-color: #bada55; color: #FF0000; text-align:center"><h4>
<b>For best results - DO A CLEAN INSTALL; DELETE EXISTING INSTALLATION THEN RE-INSTALL</b></h4><p>Download the latest release only from <a href="https://www.curseforge.com/kerbal/ksp-mods/RoverAntiGravitySystem/files">CurseForge</a></p></div>
...
[forum]: https://www.curseforge.com/kerbal/ksp-mods/RoverAntiGravitySystem/files "Rover Anti Gravity System (RAGS)"
...
<!-- shields -->
[SHD:code]: https://img.shields.io/badge/CODE-%3C.NET%203.5%3E%20%3CC%203.0%3E-darkblue?style=plastic&labelColor=66ccff "Code"
[SHD:mod]: https://img.shields.io/badge/Rover%20Anti%20Gravity%20System%20(RAGS)%20-v1.7.0.0--release-BADA55.svg?style=plastic&labelColor=darkgreen/ "1.7.0.0-release"
